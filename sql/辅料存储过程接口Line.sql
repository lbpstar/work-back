create procedure COST_MATL_QUERY_LINE
@cmonth varchar(20)
as
set nocount on
...
exec(@sql)
select t.line MES线体,t.materialcode 物料编码,t.materialname 物料名称 ,t.qty 数量,t.unit 单位,l.CNAME ERP线体,s.CID,s.CNAME 营业类型,d.MODULE_ID,d.SUB_ID,d.CNAME 车间 
from #temp t left join COST_LINETYPE l on t.line = l.CNAME_MES
left join COST_SALETYPE s on l.SALETYPE_ID = s.CID
left join COST_BASE_DATA d on l.WORK_SHOP = d.SUB_ID and d.MODULE_ID = 3 group by t.line 
