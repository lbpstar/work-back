...
namespace SMTCost
{
    public partial class SMTCostMonth : DevExpress.XtraEditors.XtraForm
    {
        public SMTCostMonth()
        {
            InitializeComponent();
        }
        private static SMTCostMonth smtcmform = null;
