...
namespace SMTCost
{
    public partial class SMTCostDeptMonth : DevExpress.XtraEditors.XtraForm
    {
        public SMTCostDeptMonth()
        {
            InitializeComponent();
        }
        private static SMTCostDeptMonth smtdmform = null;
