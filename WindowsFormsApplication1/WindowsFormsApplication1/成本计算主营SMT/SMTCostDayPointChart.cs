...
namespace SMTCost
{
    public partial class SMTCostDayPointChart : DevExpress.XtraEditors.XtraForm
    {
        public SMTCostDayPointChart()
        {
            InitializeComponent();
        }
        private static SMTCostDayPointChart smtcdcform = null;

        public static SMTCostDayPointChart GetInstance()
        {
            if (smtcdcform == null || smtcdcform.IsDisposed)
            {
                smtcdcform = new SMTCostDayPointChart();
            }
            return smtcdcform;
        }
