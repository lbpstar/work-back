...
namespace SMTCost
{
    public partial class SMTCostDeptDayChart : DevExpress.XtraEditors.XtraForm
    {
        public SMTCostDeptDayChart()
        {
            InitializeComponent();
        }
        private static SMTCostDeptDayChart smtcddcform = null;

        public static SMTCostDeptDayChart GetInstance()
        {
            if (smtcddcform == null || smtcddcform.IsDisposed)
            {
                smtcddcform = new SMTCostDeptDayChart();
            }
            return smtcddcform;
        }
