...
namespace SMTCost
{
    public partial class SMTCostDayChart : DevExpress.XtraEditors.XtraForm
    {
        public SMTCostDayChart()
        {
            InitializeComponent();
        }
        private static SMTCostDayChart smtcdcform = null;

        public static SMTCostDayChart GetInstance()
        {
            if (smtcdcform == null || smtcdcform.IsDisposed)
            {
                smtcdcform = new SMTCostDayChart();
            }
            return smtcdcform;
        }
