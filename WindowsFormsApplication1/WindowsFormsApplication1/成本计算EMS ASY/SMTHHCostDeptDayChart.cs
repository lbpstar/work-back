...
namespace SMTCost
{
    public partial class SMTHHCostDeptDayChart : DevExpress.XtraEditors.XtraForm
    {
        public SMTHHCostDeptDayChart()
        {
            InitializeComponent();
        }
        private static SMTHHCostDeptDayChart smtcddcform = null;

        public static SMTHHCostDeptDayChart GetInstance()
        {
            if (smtcddcform == null || smtcddcform.IsDisposed)
            {
                smtcddcform = new SMTHHCostDeptDayChart();
            }
            return smtcddcform;
        }
