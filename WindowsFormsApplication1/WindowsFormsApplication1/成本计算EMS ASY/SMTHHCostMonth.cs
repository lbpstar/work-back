...
namespace SMTCost
{
    public partial class SMTHHCostMonth : DevExpress.XtraEditors.XtraForm
    {
        public SMTHHCostMonth()
        {
            InitializeComponent();
        }
        private static SMTHHCostMonth smtcmform = null;

        public static SMTHHCostMonth GetInstance()
        {
            if (smtcmform == null || smtcmform.IsDisposed)
            {
                smtcmform = new SMTHHCostMonth();
            }
            return smtcmform;
        }       
        ...
        private void SMTHHCostMonth_Load(object sender, EventArgs e)
        {
            ShowDetail();
