...
namespace SMTCost
{
    public partial class SMTHHCostDeptMonth : DevExpress.XtraEditors.XtraForm
    {
        public SMTHHCostDeptMonth()
        {
            InitializeComponent();
        }
        private static SMTHHCostDeptMonth smtdmform = null;

        public static SMTHHCostDeptMonth GetInstance()
        {
            if (smtdmform == null || smtdmform.IsDisposed)
            {
                smtdmform = new SMTHHCostDeptMonth();
            }
            return smtdmform;
        }      
        ...
        private void SMTHHCostDeptMonth_Load(object sender, EventArgs e)
        {
            ShowDetail();
