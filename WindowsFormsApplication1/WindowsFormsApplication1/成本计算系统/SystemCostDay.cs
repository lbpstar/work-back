...
namespace SMTCost
{
    public partial class SystemCostDay : DevExpress.XtraEditors.XtraForm
    {
        public SystemCostDay()
        {
            InitializeComponent();
        }
        private static SystemCostDay smtcdform = null;

        public static SystemCostDay GetInstance()
        {
            if (smtcdform == null || smtcdform.IsDisposed)
            {
                smtcdform = new SystemCostDay();
            }
            return smtcdform;
        }
        ...
        private void SystemCostDay_Load(object sender, EventArgs e)
        {
            ShowDetail();
