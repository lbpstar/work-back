...
namespace SMTCost
{
    public partial class SystemCostDayChart : DevExpress.XtraEditors.XtraForm
    {
        public SystemCostDayChart()
        {
            InitializeComponent();
        }
        private static SystemCostDayChart smtcdcform = null;

        public static SystemCostDayChart GetInstance()
        {
            if (smtcdcform == null || smtcdcform.IsDisposed)
            {
                smtcdcform = new SystemCostDayChart();
            }
            return smtcdcform;
        }
