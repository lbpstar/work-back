...
namespace SMTCost
{
    public partial class SystemCostDayPointChart : DevExpress.XtraEditors.XtraForm
    {
        public SystemCostDayPointChart()
        {
            InitializeComponent();
        }
        private static SystemCostDayPointChart smtcdcform = null;

        public static SystemCostDayPointChart GetInstance()
        {
            if (smtcdcform == null || smtcdcform.IsDisposed)
            {
                smtcdcform = new SystemCostDayPointChart();
            }
            return smtcdcform;
        }
        ...
        private void SystemCostDayChart_Load(object sender, EventArgs e)
        {
            BindChart();
            //SetTitle();
