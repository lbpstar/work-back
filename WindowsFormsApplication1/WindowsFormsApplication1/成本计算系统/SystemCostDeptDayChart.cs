...
namespace SMTCost
{
    public partial class SystemCostDeptDayChart : DevExpress.XtraEditors.XtraForm
    {
        public SystemCostDeptDayChart()
        {
            InitializeComponent();
        }
        private static SystemCostDeptDayChart smtcddcform = null;

        public static SystemCostDeptDayChart GetInstance()
        {
            if (smtcddcform == null || smtcddcform.IsDisposed)
            {
                smtcddcform = new SystemCostDeptDayChart();
            }
            return smtcddcform;
        }
