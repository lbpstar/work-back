...
namespace SMTCost
{
    public partial class SystemCostMonth : DevExpress.XtraEditors.XtraForm
    {
        public SystemCostMonth()
        {
            InitializeComponent();
        }
        private static SystemCostMonth smtcmform = null;

        public static SystemCostMonth GetInstance()
        {
            if (smtcmform == null || smtcmform.IsDisposed)
            {
                smtcmform = new SystemCostMonth();
            }
            return smtcmform;
        }
        ...
        private void SystemCostMonth_Load(object sender, EventArgs e)
        {
            ShowDetail();
