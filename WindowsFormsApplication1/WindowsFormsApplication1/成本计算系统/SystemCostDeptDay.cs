...
namespace SMTCost
{
    public partial class SystemCostDeptDay : DevExpress.XtraEditors.XtraForm
    {
        public SystemCostDeptDay()
        {
            InitializeComponent();
        }
        private static SystemCostDeptDay smtddform = null;

        public static SystemCostDeptDay GetInstance()
        {
            if (smtddform == null || smtddform.IsDisposed)
            {
                smtddform = new SystemCostDeptDay();
            }
            return smtddform;
        }
        ...
        private void SystemCostDeptDay_Load(object sender, EventArgs e)
        {
            BindDept();
            ShowDetail();
