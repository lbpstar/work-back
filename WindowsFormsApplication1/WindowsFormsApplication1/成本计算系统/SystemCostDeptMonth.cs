...
namespace SMTCost
{
    public partial class SystemCostDeptMonth : DevExpress.XtraEditors.XtraForm
    {
        public SystemCostDeptMonth()
        {
            InitializeComponent();
        }
        private static SystemCostDeptMonth smtdmform = null;

        public static SystemCostDeptMonth GetInstance()
        {
            if (smtdmform == null || smtdmform.IsDisposed)
            {
                smtdmform = new SystemCostDeptMonth();
            }
            return smtdmform;
        }
        ...
        private void SystemCostDeptMonth_Load(object sender, EventArgs e)
        {
            ShowDetail();
