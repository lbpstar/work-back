...
namespace SMTCost
{
    public partial class ProductCostDeptDayChart : DevExpress.XtraEditors.XtraForm
    {
        public ProductCostDeptDayChart()
        {
            InitializeComponent();
        }
        private static ProductCostDeptDayChart smtcddcform = null;

        public static ProductCostDeptDayChart GetInstance()
        {
            if (smtcddcform == null || smtcddcform.IsDisposed)
            {
                smtcddcform = new ProductCostDeptDayChart();
            }
            return smtcddcform;
        }
