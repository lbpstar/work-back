...
namespace SMTCost
{
    public partial class ProductCostDeptMonth : DevExpress.XtraEditors.XtraForm
    {
        public ProductCostDeptMonth()
        {
            InitializeComponent();
        }
        private static ProductCostDeptMonth smtdmform = null;

        public static ProductCostDeptMonth GetInstance()
        {
            if (smtdmform == null || smtdmform.IsDisposed)
            {
                smtdmform = new ProductCostDeptMonth();
            }
            return smtdmform;
        }
        ...
        private void ProductCostDeptMonth_Load(object sender, EventArgs e)
        {
            ShowDetail();
