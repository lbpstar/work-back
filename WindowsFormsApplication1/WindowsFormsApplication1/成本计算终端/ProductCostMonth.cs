...
namespace SMTCost
{
    public partial class ProductCostMonth : DevExpress.XtraEditors.XtraForm
    {
        public ProductCostMonth()
        {
            InitializeComponent();
        }
        private static ProductCostMonth smtcmform = null;

        public static ProductCostMonth GetInstance()
        {
            if (smtcmform == null || smtcmform.IsDisposed)
            {
                smtcmform = new ProductCostMonth();
            }
            return smtcmform;
        }
        ...
        private void ProductCostMonth_Load(object sender, EventArgs e)
        {
            ShowDetail();
