...
namespace SMTCost
{
    public partial class ProductCostDeptDay : DevExpress.XtraEditors.XtraForm
    {
        public ProductCostDeptDay()
        {
            InitializeComponent();
        }
        private static ProductCostDeptDay smtddform = null;

        public static ProductCostDeptDay GetInstance()
        {
            if (smtddform == null || smtddform.IsDisposed)
            {
                smtddform = new ProductCostDeptDay();
            }
            return smtddform;
        }
        ...
        private void ProductCostDeptDay_Load(object sender, EventArgs e)
        {
            BindDept();
            ShowDetail();
