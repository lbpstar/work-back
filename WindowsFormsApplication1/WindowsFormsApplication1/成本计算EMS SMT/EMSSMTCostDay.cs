...
namespace SMTCost
{
    public partial class EMSSMTCostDay : DevExpress.XtraEditors.XtraForm
    {
        public EMSSMTCostDay()
        {
            InitializeComponent();
        }
        private static EMSSMTCostDay smtcdform = null;

        public static EMSSMTCostDay GetInstance()
        {
            if (smtcdform == null || smtcdform.IsDisposed)
            {
                smtcdform = new EMSSMTCostDay();
            }
            return smtcdform;
        }
