...
namespace SMTCost
{
    public partial class EMSSMTCostDeptDayChart : DevExpress.XtraEditors.XtraForm
    {
        public EMSSMTCostDeptDayChart()
        {
            InitializeComponent();
        }
        private static EMSSMTCostDeptDayChart smtcddcform = null;

        public static EMSSMTCostDeptDayChart GetInstance()
        {
            if (smtcddcform == null || smtcddcform.IsDisposed)
            {
                smtcddcform = new EMSSMTCostDeptDayChart();
            }
            return smtcddcform;
        }
