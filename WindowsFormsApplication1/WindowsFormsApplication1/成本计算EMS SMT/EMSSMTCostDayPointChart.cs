...
namespace SMTCost
{
    public partial class EMSSMTCostDayPointChart : DevExpress.XtraEditors.XtraForm
    {
        public EMSSMTCostDayPointChart()
        {
            InitializeComponent();
        }
        private static EMSSMTCostDayPointChart smtcdcform = null;

        public static EMSSMTCostDayPointChart GetInstance()
        {
            if (smtcdcform == null || smtcdcform.IsDisposed)
            {
                smtcdcform = new EMSSMTCostDayPointChart();
            }
            return smtcdcform;
        }
