...
namespace SMTCost
{
    public partial class EMSSMTCostDayChart : DevExpress.XtraEditors.XtraForm
    {
        public EMSSMTCostDayChart()
        {
            InitializeComponent();
        }
        private static EMSSMTCostDayChart smtcdcform = null;

        public static EMSSMTCostDayChart GetInstance()
        {
            if (smtcdcform == null || smtcdcform.IsDisposed)
            {
                smtcdcform = new EMSSMTCostDayChart();
            }
            return smtcdcform;
        }
